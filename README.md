...
- [x] **Fase 4** — Estado "Comedor cerrado" limpio (sin textos adicionales)
- [x] **Fase 5** — `debug-layout.html` (matriz 1–20 × 6 contenidos × 4 resoluciones)
- [x] **Fase 6** — Tests automatizados (`node tests/run-layout-tests.mjs`)
